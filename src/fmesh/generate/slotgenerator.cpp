...
namespace fmesh
{
	...
	void SlotGenerator::build()
	{
		...
		fmesh::offsetAndExtendPolyTree(m_poly, 0, m_adParam.extend_width / 2.0, m_adParam.bottom_height, botomSteppolys.at(0));
		fmesh::offsetAndExtendPolyTree(m_poly, 0, m_adParam.extend_width / 2.0, m_adParam.bottom_height + 0.5, botomSteppolys.at(1));
		fmesh::offsetAndExtendPolyTree(m_poly, 0, m_adParam.extend_width / 2.0, m_adParam.bottom_height+0.5, botomSteppolys.at(2));
		...
		m_adParam.bottom_height = m_adParam.extend_width / 2.0;
